...
const ContentCard = ({ item, delay = 0 }: ContentCardProps) => {
  return (
    <MotionCard
      ...
      viewport={{ once: true }}
      className="group relative h-full rounded-3xl border border-border/60 bg-background/85 shadow-lg backdrop-blur-xl transition-colors duration-300 hover:border-primary/45 hover:shadow-[0_6px_6px_rgba(0,84,159,0.16)]"
    >
